...
<body>
    ...
    <div class="d-flex justify-content-between p-3">
        <a class="btn btn-outline-dark" href="/user1/product/signature">
            Signature
        </a>
        <a class="btn btn-dark" href="/user1/product/basic">
            Basic
        </a>
