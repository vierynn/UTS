...
<head>
    ...
    <title>Biscoffee | Signature</title>
...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark d-flex justify-content-center p-2 sticky-top">
        ...
        <div class="btn-group btn-group-toggle pb-2">
            <a class="btn btn-outline-light" href="/user1">
    ...
    <div class="d-flex justify-content-between p-3">
        <a class="btn btn-dark" href="/user1/product/signature">
            Signature
        </a>
        <a class="btn btn-outline-dark" href="/user1/product/basic">
            Basic
        </a>
        <a class="btn btn-outline-dark" href="/user1/product/cream">
            Cream
        </a>
        <a class="btn btn-outline-dark" href="/user1/product/tea">
            Tea
        </a>
    </div>
        ...
        @foreach ($products as $pro)
            ...
            <div class="modal fade" id="myModal-{{ $pro->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered p-4" role="document">
                    ...
                    <form name="add-form" id="add-form" action="{{url('store-form')}}" method="post">
                        @csrf
